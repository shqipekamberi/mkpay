        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillSplits_AspNetUsers_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentRequests_AspNetUsers_RequesteeId",
                        column: x => x.RequesteeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentRequests_AspNetUsers_RequesterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillSplitParticipants_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillSplitId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transactions_BillSplits_BillSplitId",
                        column: x => x.BillSplitId,
                        principalTable: "BillSplits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillSplitParticipants_BillSplitId_UserId",
                table: "BillSplitParticipants",
                columns: new[] { "BillSplitId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BillSplitParticipants_IsPaid",
                table: "BillSplitParticipants",
                column: "IsPaid");

            migrationBuilder.CreateIndex(
                name: "IX_BillSplitParticipants_UserId",
                table: "BillSplitParticipants",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_BillSplits_CreatedAt",
                table: "BillSplits",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_BillSplits_CreatorId",
                table: "BillSplits",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_BillSplits_IsSettled",
                table: "BillSplits",
                column: "IsSettled");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentRequests_ExpiresAt",
                table: "PaymentRequests",
                column: "ExpiresAt");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentRequests_RequesteeId",
                table: "PaymentRequests",
                column: "RequesteeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_BillSplitId",
                table: "Transactions",
                column: "BillSplitId");
